PROJECT_NAME     := bootloader_pinetime-cos
...
bootloader_pinetime-cos: CFLAGS += -D__HEAP_SIZE=0
bootloader_pinetime-cos: ASMFLAGS += -D__HEAP_SIZE=0
...
default: bootloader_pinetime-cos
